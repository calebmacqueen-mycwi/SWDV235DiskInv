...
<%-- Caleb MacQueen 11/16/2018 Page Created 
     Caleb MacQueen 11/29/2018 Added dropdowns for disk status--%>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CD_ID"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Status">
                            <EditItemTemplate>
                                <div class="col-xs-11 col-edit">
                                    <asp:DropDownList ID="Statustxt" runat="server" CssClass="form-control" DataSourceID="sqlDataSource3" 
                                    DataTextField="StatusType" DataValueField="StatusType" SelectedValue='<%# Bind("StatusType") %>'>
                                </asp:DropDownList>
                                </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DIConnection %>" SelectCommand="SELECT Distinct [StatusType] FROM [CD]"></asp:SqlDataSource>
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField>
                            <InsertItemTemplate>
                                ...
                                <asp:DropDownList ID="Statustxt" runat="server" CssClass="form-control" DataSourceID="sqlDataSource3" 
                                    DataTextField="StatusType" DataValueField="StatusType" SelectedValue='<%# Bind("S") %>'>
                                </asp:DropDownList>
                                </InsertItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
